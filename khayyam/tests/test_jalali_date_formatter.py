...
class JalaliDateFormatterTestCase(unittest.TestCase):
    ...
    def test_year(self):
        ...
        self.assertEqual(JalaliDate.strptime('94', '%y'), JalaliDate(1494))
        self.assertEqual(JalaliDate.strptime('01', '%y'), JalaliDate(1401))
        self.assertEqual(JalaliDate.strptime('00', '%y'), JalaliDate(1400))
        self.assertEqual(JalaliDate.strptime(u'۹۴', '%n'), JalaliDate(1494))
        self.assertEqual(JalaliDate.strptime(u'۱', '%n'), JalaliDate(1401))
        self.assertEqual(JalaliDate.strptime(u'۰', '%n'), JalaliDate(1400))
        self.assertEqual(JalaliDate.strptime(u'۹۴', '%u'), JalaliDate(1494))
        self.assertEqual(JalaliDate.strptime(u'۰۱', '%u'), JalaliDate(1401))
        self.assertEqual(JalaliDate.strptime(u'۰۰', '%u'), JalaliDate(1400))
